...
const Suppliers: React.FC = () => {
  ...
  const [newSupplier, setNewSupplier] = useState<Supplier>({ id: '', name: '', phone: '', notes: '', discountNormal: 0, discountSpecial: 0, discountOther: 0 });
  ...
  const handleSave = () => {
    ...
    setSuppliers(StorageService.getSuppliers());
    setNewSupplier({ id: '', name: '', phone: '', notes: '', discountNormal: 0, discountSpecial: 0, discountOther: 0 });
  };
